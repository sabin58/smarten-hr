    ...
    AD: {
      ...
      GetFullDate: function (e, t) {
        ...
        return (
          ...
          (t = n.dateFormat),
          e
            ? `${e.day} ${NepaliFunctions.AD.GetMonth(e.month - 1)} ${e.year}`
            : null
        );
      },
      ...
      DatesDiff: function (e, t, n) {
        ...
        return (
          ...
          e && (t = s(t, n).dateObject)
            ? !(!E(e) || !E(t)) &&
              ((e = h(e)), (t = h(t)), new l().countAdDays(e, t))
            : null
        );
      },
      AddDays: function (e, t, n) {
...
!(function () {
      ...
      i.getElementsByTagName("table")[0].insertAdjacentElement(
        ...
        (function (e, t, n, r) {
          ...
          for (; Y < A; ) {
            ...
            (F % 7 == 6 &&
              (S.appendChild(E), (E = document.createElement("TR"))),
              (Y += 1));
          }
  ...
  function m(e) {
    ...
    if ((e || (e = r), e)) {
      ...
      (Number.isInteger(d) &&
        d >= 0 &&
        (o = NepaliFunctions.BS.AddDays(
          NepaliFunctions.BS.GetCurrentDate(),
          -1 * d,
        )),
        Number.isInteger(l) &&
          l >= 0 &&
          (u = NepaliFunctions.BS.AddDays(
            NepaliFunctions.BS.GetCurrentDate(),
            l,
          )));
      var s = [];
      ...
      if (
        ...
        if (t.disableBefore || t.disableAfter) {
          ...
          t.disableAfter &&
            ...
            NepaliFunctions.BS.IsGreaterThan(F, v) ||
              ((D = F.year), (M = F.month)));
        }
        d(D, M, "", t.id);
      }
